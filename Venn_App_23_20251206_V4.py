...
.stSlider, .stColorPicker, .stNumberInput {
...
# ===== Sidebar 標題與說明文字 =====
st.sidebar.markdown('<p style="font-size:20px; font-weight:700; color:#333333;">文氏圖設定</p>', unsafe_allow_html=True)
st.sidebar.markdown('<p style="font-size:14px; color:#555555;">請設定集合大小、顏色與交集數值。</p>', unsafe_allow_html=True)

# ===== Sidebar 選擇 Venn 類型 =====
st.sidebar.markdown('<p style="font-size:16px; font-weight:600; color:#333333;">選擇圖形類型：</p>', unsafe_allow_html=True)
mode = st.sidebar.radio("", ["2 圓", "3 圓"])

# ===== Sidebar 通用顯示設定 =====
st.sidebar.markdown('<p style="font-size:16px; font-weight:600; color:#333333;">顯示設定：</p>', unsafe_allow_html=True)
show_labels = st.sidebar.checkbox("顯示圓標籤（Set1 / Set2 / Set3）", value=True)
show_values = st.sidebar.checkbox("顯示區塊數字", value=True)

st.sidebar.markdown('<p style="font-size:16px; font-weight:600; color:#333333;">圖片大小設定：</p>', unsafe_allow_html=True)
