...
# ==========================================
# Code-V2-FontFix：中文不亂碼＋本地 ttf 字型載入
# ==========================================

import streamlit as st
import matplotlib.pyplot as plt
import matplotlib.font_manager as fm   # ← 必須先 import 才能用 fm

# ============================
# 載入本地 ttf 字型（避免亂碼）
# ============================
FONT_PATH = "NotoSansTC-Regular.ttf"    # ttf 與 .py 放同資料夾
...
# ============================
# 系統字型 fallback（在找不到 ttf 時仍能顯示中文）
# ============================
try:
...
# plt.rcParams['font.sans-serif'] = ['Noto Sans CJK JP']     # Linux/其他

plt.rcParams['axes.unicode_minus'] = False  # 預防負號亂碼
